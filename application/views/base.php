...
<body class="stretched">
						...
						<ul>
							...
							<li><a href="#"><?php echo $this->lang->line('menu_login_title'); ?></a>
								<div class="top-link-section">
									<form id="top-login" action="<?php echo base_url(); ?>login_public" method="post" role="form">
				...
				<div class="container clearfix">
					...
					<nav id="primary-menu" class="sub-title">
						...
						<ul>
							...
							<!-- NOSOTROS -->
							<li id="li_proit">
								<a href="#"><div><?php echo $this->lang->line('link_home_proit'); ?></div><span><?php echo $this->lang->line('link_home_proit_sub'); ?></span></a>
								<ul>
									<!--<li><a href="about_us"><div><?php echo $this->lang->line('link_nosotros'); ?></div></a></li>-->
									<li>
										<a href="<?php echo base_url(); ?>partnerships"><div><?php echo $this->lang->line('link_partnerships'); ?></div></a>
									</li>
								</ul>
							</li>
							
							<!-- SOLUCIONES -->
							<li id="li_solutions"><a href="#"><div><?php echo $this->lang->line('link_soluciones'); ?></div><span><?php echo $this->lang->line('link_soluciones_sub'); ?></span></a>
								<ul>
									<li id="li_smartindustries"><a href="<?php echo base_url(); ?>solutions/smartindustries"><div><?php echo $this->lang->line('link_smartindustries'); ?></div><span><?php echo $this->lang->line('link_smartindustries_sub'); ?></span></a></li>
									<li id="li_smartcities"><a href="<?php echo base_url(); ?>solutions/smartcities"><div><?php echo $this->lang->line('link_ciudades'); ?></div><span><?php echo $this->lang->line('link_ciudades_sub'); ?></span></a></li>
							...
							<!-- CONTACTO -->
							<li id="li_contact">
								<a href="<?php echo base_url(); ?>contacts"><div><?php echo $this->lang->line('link_contactos'); ?></div><span><?php echo $this->lang->line('link_contactos_sub'); ?></span></a>
							</li>
	...
	<script type="text/javascript">
		...
		}else if($("#section").val() == "solutions"){
			$("#li_solutions").addClass('current');
