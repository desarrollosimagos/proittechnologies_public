			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide dark">
							...
							<div class="heading-block nobottommargin center">
								<h1>
									<span class="text-rotater nocolor" data-separator="|" data-rotate="flipInX" data-speed="3500">
										PROIT TECHNOLOGIES SUPPLY IT SOLUTIONS FOR <br><span class="t-rotate">Energy Consumption| Green Spaces|Waste Management|Fleet Management|Products Marketplace|Citizens Community</span>
									</span>
								</h1>
					...
					<div class="video-wrap">
						<video id="video1" poster="<?php echo assets_url(); ?>images/videos/explore-smartcities.jpg" preload="auto" loop autoplay muted>
							<source src='<?php echo assets_url(); ?>images/videos/cities.mp4' type='video/mp4'/>
							<source src='<?php echo assets_url(); ?>images/videos/cities.webm' type='video/webm'/>
					...
					<div class="container clearfix">
						<div class="vertical-middle dark center">
							...
							<div class="heading-block nobottommargin center">
								<h1>
									<span class="text-rotater nocolor" data-separator="|" data-rotate="flipInX" data-speed="3500">
										PROIT TECHNOLOGIES SUPPLY IT SOLUTIONS FOR <br><span class="t-rotate">Energy Management
 |Waste Collection|Green Spaces| Agriculture |Products Marketplace|Cargo Management | Fleet Management | Aquaculture </span>
									</span>
								</h1>
					...
					<div class="video-wrap">
						<video id="video2" poster="<?php echo assets_url(); ?>images/videos/explore-smartindustries.jpg" preload="auto" loop autoplay muted>
							<source src='<?php echo assets_url(); ?>images/videos/industry.mp4' type='video/mp4'/>
							<source src='<?php echo assets_url(); ?>images/videos/industry.webm' type='video/webm'/>
							Tu navegador no soporta HTML5 Video
						</video>
						<div class="video-overlay" style="background-color: rgba(0,0,0,0.55);"></div>
					</div>
